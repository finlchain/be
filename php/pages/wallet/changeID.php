			...
			<div class="row">
				<div class="col-lg-12">
					<div class="view-header">
						...
						<h3 style="padding: 12px">ChangeID & ChangeKey</h3>

						<input type="hidden"id="ChangeUseridd"/>									
...
<script type="text/javascript">$(document).ready(function(){$("#ChangeUseridd").trigger("click");});</script>
