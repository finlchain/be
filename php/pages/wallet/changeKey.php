			...
			<div class="row">
				<div class="col-lg-12">
					<div class="view-header">
						...
						<h3 style="padding: 12px">ChangeKey</h3>

						<input type="hidden"id="ChangeUserkeyd"/>									
...
<script type="text/javascript">$(document).ready(function(){$("#ChangeUserkeyd").trigger("click");});</script>
