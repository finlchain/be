			...
			<div class="row">
				<div class="col-lg-12">
					<div class="view-header">
						...
						<h3 style="padding: 12px">Enrollment & Change</h3>

						<input type="hidden"id="RegisterKeyNetworkd"/>									
...
<script type="text/javascript">$(document).ready(function(){$("#RegisterKeyNetworkd").trigger("click");});</script>
