			...
			<div class="row">
				<div class="col-lg-12">
					<div class="view-header">
						...
						<h3 style="padding: 12px">Restoration</h3>

						<input type="hidden"id="KeyRestorationd"/>									
...
<script type="text/javascript">$(document).ready(function(){$("#KeyRestorationd").trigger("click");});</script>
